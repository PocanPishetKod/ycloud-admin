...
import { AuthServiceWrapper } from "src/modules/core/auth/auth-wrapper.service";
import { RouterService } from "src/modules/core/routing/router.service";
...
export class SignInRedirectComponent implements OnInit {
    ...
    public ngOnInit(): void {
        this._activatedRoute.queryParams.subscribe(async params => {
            ...
            this._routerService.goToDrives();
        });
    }
}